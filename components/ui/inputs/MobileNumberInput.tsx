...
import { BodyText, TitleText } from '@/ui/components/typography';
        ...
        <View gap="$1" pl="$1" py="$1">
          ...
          <XStack gap="$2" position="relative">
            ...
            <Input
              ...
              onBlur={onBlur}
              focusStyle={{
                borderBottomColor: error ? '$stroke/error' : '$stroke/secondary',
              }}
              keyboardType="numeric"
              {...rest}
            />
            {showDeleteButton && value.length !== 0 && (
              <View position="absolute" right="$0" top="$0" bottom="$0" justifyContent="center">
