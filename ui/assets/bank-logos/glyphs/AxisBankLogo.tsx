...
export const AxisBankLogo = ({ size = 24 }: BankIconProps) => (
  <Svg width={size} height={size} viewBox="0 0 33 32" fill="none" focusable={false}>
    ...
    />
    <Path
      d="M30.5453 28.545C27.5373 28.545 24.6541 28.545 21.7085 28.545C19.9597 25.4266 18.2045 22.3002 16.3965 19.0762C19.4157 19.0762 22.2941 19.0762 25.2221 19.0762C26.9821 22.2042 28.7421 25.337 30.5453 28.545Z"
      fill="#AE2960"
    />
  </Svg>
);
export default AxisBankLogo;
