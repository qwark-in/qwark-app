...
export const Bell = ({ size = 24, color = "currentColor" }: IconProps) => (
  ...
  >
    ...
    />
    <Path
      d="M10.3 21C10.4674 21.3044 10.7135 21.5583 11.0125 21.7352C11.3115 21.912 11.6526 22.0053 12 22.0053C12.3474 22.0053 12.6885 21.912 12.9875 21.7352C13.2866 21.5583 13.5326 21.3044 13.7 21"
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"
    />
